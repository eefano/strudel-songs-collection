...
$: "<[-3,0] [-4,0] [-2,0]>/4".layer(
     x=>x.sub(7).n().s('supersaw').clip(1).lpf("<300>/12").lpa(0).lpe("<1 1.5 2 2!3>/12").lpd(.15).struct("<x*4>"),
     x=>x.add(7).s('triangle').add(7).gain("<0 .1 .15 .2!3>/12").adsr([.5,0,1,.5]).hpf(500)
)
$: "<[0 2 5 0 3 -1 2 3 -1 -2 3 2]>".s('sine').gain("<0 0 .3 .6!3>/12")

$: n(irand(7).struct("<~@2 [x x] [x ~]>").add(6)).s('square').hpf(800).lpf(2000)
