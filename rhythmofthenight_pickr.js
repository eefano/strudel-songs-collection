// "The Rhythm Of The Night" (Corona) - Work In Progress - Now with Pickr!
const pickr = register('pickr', (arr, pat) => pat.pick(arr.map((x)=>x.restart(pat.collect().fmap(v=>v+1)))))
...
const crdpart = "<~ 0@10 1@24 0@19>".pickr(
["Ab Cm Bb F@2".slow(5)
,"Bb@3 Ab@3 Cm@2".slow(8)
]);
stack 
("<0 1@4 0 1@4 ~@8 2 3@7 2 3@7 0 1@4 0 1@4 0 1@4 0 1@4>".pickr(
  ["~ [4@3 ~]!3 7:5 6 4 3"
...
,"<[2,3] ~@10 0@6 [0,1]@2 [0,2] 0@5 [0,1]@2 [0,2] 0@6 [2,3] 0@8 [0,1]@2 [0,2] 0@8>".pickr(
