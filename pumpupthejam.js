...
]).scale("c4:minor").note().legato(0.7).s("z_sawtooth").color("red").adsr("0.07:.1:0.6:0.1").gain(0.6)
...
,"<0@4 [0,1]@12 [0,1,2]@4 [0,1,2,3]@4>".pickRestart(
 [stack(s("oh*16").pan(0.45).gain("[0.08 0.2]*4"),s("hh*4").pan(0.7).gain(0.30))
 ,s("bd*4").lpf(120).gain(1)
 ,s("[~ cp]*2").gain(0.6).pan(0.2)
