...
,"<~@8 0@4 1@4 ~@8>".pickRestart(
  ...
  ,"~ [u i] [u ~ ~ a] [i i@2 o]"
]).vowel().s("z_sawtooth").legato(0.8).gain(1.4)
             
,"<~@16 0@8>".pickRestart(
  ["[ ~@2 4 [5:1 ~] ~ [~ 0] [3:-1@5 3:1@2 2]@2 ~ [4@3:1 3 3@3 2 2@3 3 4:1@3 0 0@2 2:2@2]@5 [~ ~ 0@2 ~ 0@2 -2:-3]@2 ]/4"
]).as("n:penv").scale("c4:minor").legato(0.90).patt("0.15").s("square").delay(0.3).dfb(0.3).dt(60/128).gain(0.7)
...
,"<0@12 0 1 ~@2 3@8>".pickRestart(
  ...
  ,"~@2 [~ [e2 ~]] [[0 2] ~]"
  ,"[0 ~ ~ 0 ~ ~ 0 ~] <[[~ [0 1]] [2 ~]] ~>"
]).scale("c2:minor").note().legato(0.9)  
      .superimpose(x=>x.s("sawtooth").delay(0.6).dfb(0.5).dt(60/125*3/4).pan(0.7).gain(0.9))
      .superimpose(x=>x.s("square").lpf(200).lpe(2).lpa(-1.5).lpd(0.1).lpr(0.05).pan(0.3).gain(1.2))   
      .color("green")
