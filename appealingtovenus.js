// "Appealing to Venus" (By Tim Smith of The Sea Nymphs) 
const chords = `Cm@2 Ab@2 Db@2 Cm F Bb C@2 F Bb C@2 F Bb Eb Dm [Cm Dm] [Eb ~] Eb Dm [Cm Dm] [Eb ~]
                C@2 Ab Eb Ab A E B Db Cm [Bbm Cm] [Db ~] Db Cm [Bbm Cm] [Db ~]`
stack( 
  // melody
  `[
   ...
   ~@24
    ...
    ~@24
   ]`.legato(0.95).note().s('gm_oboe').gain(0.5)
  ,
  // second voice
  `[
    ~@150
  ...
  chord(chords).anchor("C5").voicing().struct("x*82").piano().gain(0.4),
  chord(chords).anchor("E5").voicing().s('gm_drawbar_organ').gain(0.15),
  
).slow(45).room(0.4).pianoroll()